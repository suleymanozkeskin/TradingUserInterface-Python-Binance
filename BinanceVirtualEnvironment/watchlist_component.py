...
class Watchlist(tk.Frame):
    def __init__(self, binance_contracts: typing.Dict[str, Contract], *args, **kwargs):
        ...
        self._binance_label = tk.Label(self._commands_frame, text="Binance", bg=BackGround_Colour, fg=ForeGround_Colour , font=BOLD_FONT)
        self._binance_label.grid(row=0, column=0)

        self._binance_entry = tk.Entry(self._commands_frame, fg=ForeGround_Colour, justify=tk.CENTER, insertbackground=ForeGround_Colour,
        ...
        for idx, h in enumerate(self._headers):
            header = tk.Label(self._table_frame, text=h.capitalize() if h != "remove" else "", bg=BackGround_Colour,
    ...
    def _add_symbol(self, symbol: str, exchange: str):
        ...
        self.body_widgets['symbol'][b_index] = tk.Label(self._table_frame, text=symbol, bg=BackGround_Colour, fg=ForeGround_Colour_2,
                                                        font=GLOBAL_FONT)
        self.body_widgets['symbol'][b_index].grid(row=b_index, column=0)

        self.body_widgets['exchange'][b_index] = tk.Label(self._table_frame, text=exchange, bg=BackGround_Colour, fg=ForeGround_Colour_2,
                                                          font=GLOBAL_FONT)
        ...
        self.body_widgets['remove'][b_index] = tk.Button(self._table_frame, text="X",
                                                         bg="darkred", fg=ForeGround_Colour, font=GLOBAL_FONT,
