...
class TradesWatch(tk.Frame):
    def __init__(self, *args, **kwargs):
        ...
        for idx, h in enumerate(self._headers):
            header = tk.Label(self._table_frame, text=h.capitalize(), bg=BackGround_Colour,
                              fg=ForeGround_Colour, font=BOLD_FONT)
    ...
    def add_trade(self, data: typing.Dict):
        ...
        self.body_widgets['time'][t_index] = tk.Label(self._table_frame, text=data['time'], bg=BackGround_Colour, fg=ForeGround_Colour_2,
                                                      font=GLOBAL_FONT)
        self.body_widgets['time'][t_index].grid(row=b_index, column=0)

        # Symbol

        self.body_widgets['symbol'][t_index] = tk.Label(self._table_frame, text=data['symbol'], bg=BackGround_Colour,
                                                        fg=ForeGround_Colour_2, font=GLOBAL_FONT)
        self.body_widgets['symbol'][t_index].grid(row=b_index, column=1)

        # Exchange

        self.body_widgets['exchange'][t_index] = tk.Label(self._table_frame, text=data['exchange'], bg=BackGround_Colour,
                                                        fg=ForeGround_Colour_2, font=GLOBAL_FONT)
        self.body_widgets['exchange'][t_index].grid(row=b_index, column=2)

        # Strategy

        self.body_widgets['strategy'][t_index] = tk.Label(self._table_frame, text=data['strategy'], bg=BackGround_Colour,
                                                        fg=ForeGround_Colour_2, font=GLOBAL_FONT)
        self.body_widgets['strategy'][t_index].grid(row=b_index, column=3)

        # Side

        self.body_widgets['side'][t_index] = tk.Label(self._table_frame, text=data['side'], bg=BackGround_Colour,
                                                      fg=ForeGround_Colour_2, font=GLOBAL_FONT)
        self.body_widgets['side'][t_index].grid(row=b_index, column=4)

        # Quantity

        self.body_widgets['quantity'][t_index] = tk.Label(self._table_frame, text=data['quantity'], bg=BackGround_Colour,
                                                          fg=ForeGround_Colour_2, font=GLOBAL_FONT)
        ...
        self.body_widgets['status'][t_index] = tk.Label(self._table_frame,
                                                        ...
                                                        bg=BackGround_Colour, fg=ForeGround_Colour_2, font=GLOBAL_FONT)
        ...
        self.body_widgets['pnl'][t_index] = tk.Label(self._table_frame,
                                                     textvariable=self.body_widgets['pnl_var'][t_index], bg=BackGround_Colour,
                                                     fg=ForeGround_Colour_2, font=GLOBAL_FONT)
